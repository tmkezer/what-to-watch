...
def most_similar_users_(user1, number_of_users, index, metric='pearson'):
    ...
    #index =i = id of the random user to whom to compare, between 0 and 10000
...
#################################################################################
 ########## ha ha ha #######  For Existing Users ########### ho ho ho ############
 ####################### Add Invalid Users Entry ##################################
...
uentry = input("Do you wish to rate movies and get a reccomendation: y/n? ")
